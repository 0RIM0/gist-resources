...
var _initClass, _init__text, _init_extra__text, _initClass2, _init_text, _init_extra_text;
...
(class extends i {
	static {
		({e: [_init__text, _init_extra__text], c: [_MyElement, _initClass]} = _applyDecs(this, [t("my-element")], [[
			r(),
			1,
			"_text"
		]], 0, void 0, i));
...
(class extends i {
	static {
		({e: [_init_text, _init_extra_text], c: [_SubElement, _initClass2]} = _applyDecs(this, [t("sub-element")], [[
			n(),
			1,
			"text"
		]], 0, void 0, i));
